...
def register_dataset(path_to_moma='../../data/moma/'):
    ...
    classes = moma.get_cnames(concept='actor', num_instances=num_instances_threshold, split='val') # Only train on actors and objects from val set
    classes += moma.get_cnames(concept='object', num_instances=num_instances_threshold, split='val') # Ensure there are at least 50 examples to include
